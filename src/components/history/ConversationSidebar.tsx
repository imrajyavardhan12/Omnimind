...
export function ConversationSidebar({ className }: ConversationSidebarProps) {
  ...
  if (isCollapsed) {
    return (
      <div className={cn('w-14 border-r border-border bg-background flex flex-col py-4 sidebar-transition overflow-hidden', className)}>
  ...
  return (
    <div className={cn('w-80 border-r border-border bg-background flex flex-col sidebar-transition overflow-hidden', className)}>
      <div className={cn('sidebar-content h-full flex flex-col', showContent ? 'opacity-100' : 'opacity-0')}>
        {/* Header */}
